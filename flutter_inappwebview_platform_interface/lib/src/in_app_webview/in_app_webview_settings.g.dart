...
class InAppWebViewSettings {
  ...
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- iOS ([Official API - WKWebView.allowsBackNavigationGestures](https://developer.apple.com/documentation/webkit/wkwebview/1414996-allowsbacknavigationgestu))
  ///- MacOS ([Official API - WKWebView.allowsBackNavigationGestures](https://developer.apple.com/documentation/webkit/wkwebview/1414996-allowsbacknavigationgestu))
  bool? allowsBackNavigationGestures;

  ///Set to `true` to allow the horizontal swipe gestures trigger back-forward list navigations. The default value is `true`.
  ///
  ///**Officially Supported Platforms/Implementations**:
  ///- iOS ([Official API - WKWebView.allowsForwardNavigationGestures](https://developer.apple.com/documentation/webkit/wkwebview/1414997-allowsforwardnavigationgestu))
  ///- MacOS ([Official API - WKWebView.allowsForwardNavigationGestures](https://developer.apple.com/documentation/webkit/wkwebview/1414997-allowsforwardnavigationgestu))
